...
游戏脚本:设计队伍中的写作者需要完成的一个文档，其中显示游戏基本的故事发展路线，并为游戏设计对话。通常也称为screenplay
...
|       |      |                                                              |
|  1/7  |      |                    阅读游戏编程模式(50%)                     |
|  1/6  |      | 阅读游戏编程模式(40%)<br />修复boingCooking运动轨迹问题，用dotween<br />修复相机跟随问题<br />引入新的输入系统<br />存疑：hingeJoint2D的自动铰链问题 |
|  1/3  |      | 阅读游戏编程模式(30%)<br />重写动画运动过程布局<br />编写部分单例学习代码 |
|  1/2  |      | 阅读游戏编程模式(20%)<br />研究全局管理问题，项目架构设计GameManager |
| 12/27 |      | 阅读游戏设计的100个原理(100%)<br />修复boingCooking项目悬杆问题<br />修复boingCooking项目弹射问题<br />修复全局控制问题 |
| 12/26 |      | 阅读游戏设计的100个原理(90%)<br />修复愤怒的小鸟项目使用错误tilemap的问题<br />修复小鸟项目没有连接预制体的问题<br />修复脚本nextlevelChange合并到GameManager中<br />修复小鸟计分系统由于协程晚于结算存储系统的问题<br />修复boingCooking中旋转杆的问题<br />完整修复愤怒的小鸟项目并完成打包 |
| 12/25 |      | 阅读游戏设计的100个原理(80%)<br />修复愤怒的小鸟问题<br />修复boingCooking初始界面的点击按钮选项问题 |
| 12/24 |      | 阅读游戏设计的100个原理(70%)<br />修复愤怒的小鸟中错误的内容 |
| 12/21 |      | 提交临时demo版本<br />修复怪物攻击错误结算时间错误<br />怪物死亡判定错误<br />加入部分音效和背景音乐<br />商店背包刷新错误<br />重新导入怪物模型(x) |
| 12/20 |      | 制作对话系统以及任务系统，修复怪物攻击判定错误，引入新的怪物<br />引入湖面shader效果<br />加入设置界面<br />引入小地图效果<br />修改跳跃条长度 |
| 12/19 |      |             制定人物攻击动作，设计多层级攻击效果             |
| 12/18 |      |                    制作史莱姆宠物跟随系统                    |
