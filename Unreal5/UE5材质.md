...
#### 3.次表面散射 Microsurface scattering
...
#### 1.10 反射/漫反射 Reflection/Diffusion
...
#### 1.4 半透明和透明 Translucency and transparency
...
```mermaid
flowchart TB
	PBR[PBR工作流] --> |金属|BC[BaseColor 基色]
	PBR --> |非金属|D[Diffuse 漫反射]
